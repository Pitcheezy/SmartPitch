...
### 1순위: Task 10 — 범용 모델 구종 군집화 통합 (학습-추론 구종 분류 일치)
...
### 3순위: Task 6 — 인플레이 타구 전이 확률 실데이터 기반 교체
...
### 4순위: Task 11 — Top-K Accuracy 측정 추가
...
| **1** | 10 | 범용 모델 구종 군집화 통합 | 어려움 | — | ✅ | ✅✅ | — |
| **2** | 5 | RE24 매트릭스 연도별 갱신 | 보통 | — | ✅ | ✅ | — |
| **3** | 6 | 인플레이 타구 확률 실데이터 교체 | 보통 | — | ✅ | ✅ | — |
| **4** | 11 | Top-K Accuracy 측정 추가 | 쉬움 | — | — | ✅ | — |
| **5** | 7 | DQN 학습 강화 (300K→500K) | 쉬움 | — | ✅ | — | Task 10,5,6 이후 |

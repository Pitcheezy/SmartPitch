...
- [x] Task 19: Cease/Gallen 개인 맞춤 DQN 학습 + 베이스라인 평가 + 백엔드 통합 문서
  ...
  - Cease: K=3 (FF/SL/CH), 5,400건, DQN +0.238 ± 1.180 (2024 RE24 기준)
  - Gallen: K=4 (FF/SL/CH/CB), 4,572건, DQN +0.279 ± 1.138 (2024 RE24 기준)
...
- [x] Task 20: RE24 시즌별 로더 도입 (하드코딩 제거)
  ...
  - scripts/compute_re24_per_season.py: Statcast play-by-play RE24 재현/검증

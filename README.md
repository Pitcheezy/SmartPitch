...
5. **RE24 갱신 (Task 20)**: pitch_env.py + mdp_solver.py의 2019 고정값을 2024 기준으로 교체
6. **MLP 정확도 향상 (Task 23~25)**: 3시즌 200만 건 학습, Calibration, 추가 피처
7. **DQN 고도화 (Task 28~30)**: 학습 스텝 증가, 탐색 전략 개선, 5000 ep 평가

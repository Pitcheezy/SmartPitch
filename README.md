...
### 베이스라인 비교 (cluster 0, 1000 에피소드, 물리피처 lookup + VI 17회 γ=0.99)

| Agent | Mean Reward ± Std | Notes |
|---|---|---|
| **DQN (Cole 2019 ref)** | **+0.436 ± 1.255** | W&B run `h4n3o0di`, action space ~52 |
| MDPPolicy (VI 17회) | +0.250 ± 1.093 | 9,216 상태, γ=0.99, entropy=1.29 |
| Frequency (Cole 2019) | +0.224 ± 1.137 | |
| MostFrequent (Cole 2019) | +0.220 ± 1.177 | |
| Random | +0.204 ± 1.156 | 117 action space |
| Frequency (2023 League) | +0.181 ± 1.155 | |

DQN이 모든 고정 정책 대비 우위. MDP는 물리 피처 lookup + VI 수렴 개선으로
초기 +0.151에서 +0.250으로 **+65% 개선**. 상세 분석:
[`docs/mdp_vs_env_reward_analysis.md`](docs/mdp_vs_env_reward_analysis.md).
...
[Medium]   군집 1~3 DQN 학습 + DQN 강화 (300K→500K, exploration 0.30→0.40)
